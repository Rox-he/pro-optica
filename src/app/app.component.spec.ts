...
const EVENTOS: EventoPromo[] = [
  {
    id: 'verano', nombre: 'Promo de Verano',
    ...
    descuento: '20% OFF', colorFondo: '#0E6E8C', colorAcento: '#FFC93C', icono: ICONO_SOL,
    inicio: { mes: 6, dia: 1 }, fin: { mes: 6, dia: 30 },
  },
  {
    id: 'regreso-clases', nombre: 'Regreso a Clases',
    ...
    descuento: '15% OFF', colorFondo: '#7A3E9D', colorAcento: '#F2B9D1', icono: ICONO_MOCHILA,
    inicio: { mes: 8, dia: 1 }, fin: { mes: 8, dia: 15 },
  },
  {
    id: 'aniversario', nombre: 'Aniversario Óptica Convicción',
    ...
    descuento: '25% OFF', colorFondo: '#C9779E', colorAcento: '#FFD166', icono: ICONO_REGALO,
    inicio: { mes: 10, dia: 18 }, fin: { mes: 10, dia: 18 },
  },
  {
    id: 'buen-fin', nombre: 'Buen Fin',
    ...
    descuento: '20% OFF', colorFondo: '#0D213A', colorAcento: '#6B8FCE', icono: ICONO_BOLSA,
    inicio: { mes: 11, dia: 14 }, fin: { mes: 11, dia: 17 },
  },
  {
    id: 'dia-madres', nombre: 'Día de las Madres',
    ...
    descuento: '2x1', colorFondo: '#13315C', colorAcento: '#F2B9D1', icono: ICONO_FLOR,
    inicio: { mes: 5, dia: 1 }, fin: { mes: 5, dia: 10 },
  },
];
...
export class EventoCalendarioService {
  obtenerEventoActivo(fecha: Date = new Date()): EventoPromo | null {
    ...
    for (const evento of EVENTOS) {
      if (this.estaEnRango(mes, dia, evento.inicio, evento.fin)) return evento;
    }
    return null;
  }
  private estaEnRango(mes: number, dia: number, inicio: { mes: number; dia: number }, fin: { mes: number; dia: number }): boolean {
